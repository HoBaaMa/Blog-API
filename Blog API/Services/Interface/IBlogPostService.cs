...
namespace Blog_API.Services.Interface
{
    ...
    {
        Task<PagedResult<BlogPostDTO>> GetAllBlogPostsAsync(PaginationRequest paginationRequest, string? filterOn, string? filterQuery, string? sortBy, bool? isAscending = true);
